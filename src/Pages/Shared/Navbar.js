...
const Navbar = () => {
    ...
    const menuItems = <>
        ...
        <li>{
            user && <Link to='/dashboard'>Dashboard</Link>}</li>
        {user ?
            <li>
                <>
        ...
        <div className="sticky top-0 z-[900]">
            ...
            <div className="modal modal-bottom sm:modal-middle">
                <div className="modal-box ">
                    <h3 className="font-bold text-lg text-center">Logout?</h3>
                    <p className="text-center">Are you sure want to logout?</p>
                    <div className="modal-action flex justify-evenly">
                        <label htmlFor="logout-modal" className="btn" onClick={logOut}>Yes</label>
